...
- To run:
```bash
python bubble-sort-animation.py
```
#
> Use your `+` ad `-` key to change the speed of the animation.
#

# How to Change The Settings
- Open `bubble-sort-animation.py` using your suitable code editor.
- You can see the variable names those are self explanatory including with necessary instructions.